...
class ObjectRepositoryImpl(private val objectDatasource: ObjectDatasource) : ObjectRepository {
    ...
    override fun getObjects(): List<Object> = objectDatasource.getAllObjects().toDomain()

    override fun getDetailedObject(id: Long): DetailedObject? =
        objectDatasource.getObjectByIdWithRelations(id = id).toDetailedDomain()
